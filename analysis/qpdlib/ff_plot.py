...
class PLOTS:
    ...
    def plot_lines(self, ax, flav, c, n_replicas, lab = ''): ## plot all the FF replicas as separate lines
        ...
        for i in range(nrep):
            ...
            ax.plot(X, self.data['XF'][flav][i], color = c, linewidth = line_width)
    ...
    def line_figure1(self, wdir, had):
        ...
        for i in had:
          ...
          self.plot_lines(AX[0], 'u+ub', c, n_replicas)
    ...
    def line_figure2(self, wdir, had):
        ...
        for i in had:
          ...
          self.plot_lines(AX[0], 'u', c, n_replicas)
          self.plot_lines(AX[1], 'd' , c, n_replicas)
          self.plot_lines(AX[2], 's', c, n_replicas)
          self.plot_lines(AX[3], 'ub', c, n_replicas)

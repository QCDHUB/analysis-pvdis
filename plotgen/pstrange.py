...
############################
##--Observable plots (ratio)
############################

#dy.plot_obs(wdir,kc,ratio=True)
#zrap.plot_zrap_ratio(wdir,kc)
#wasym.plot_wasym_ratio(wdir,kc)
#wzrv.plot_wzrv_ratio(wdir,kc)
#pvdis.plot_pvdis_e_ratio(wdir,kc,kind)

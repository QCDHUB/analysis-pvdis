...
conf['params']['ppdf']['s1 N']    = {'value':   -1.21705e-01, 'min':   -10, 'max':    10, 'fixed': False, 'zero': True}
...
conf['steps'][8]['datasets']['wzrv'].append(1000)
conf['steps'][8]['datasets']['wzrv'].append(1001) 

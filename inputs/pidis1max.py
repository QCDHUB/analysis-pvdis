...
conf['datasets']['pidis']['xlsx'][90011] = 'pidis/expdata/90011.xlsx' # 90011 | proton   | A_PV | JAM4EIC | min 
conf['datasets']['pidis']['xlsx'][90021] = 'pidis/expdata/90021.xlsx' # 90021 | proton   | A_PV | JAM4EIC | max 
## --------------------------------------------------------------------------------------------------------------------------
...
conf['steps'][9]['datasets']['pidis'].append(90021)

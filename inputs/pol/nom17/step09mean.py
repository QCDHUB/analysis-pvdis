...
conf['pidis grid']['xlsx'].append('./results/pol/nom/step08filt/sim/pvdis-had-p-mod-mean.xlsx')
...
conf['datasets']['SU23']['xlsx'][30001]='SU23/expdata/30001.xlsx' #  SU2   | nominal +- JAM17 uncertainties
conf['datasets']['SU23']['xlsx'][30002]='SU23/expdata/30002.xlsx' #  SU3   | nominal +- JAM17 uncertainties
...
conf['steps'][9]['datasets']['pidis'].append(90001) # JAM4EIC | proton | moderate | mean
conf['steps'][9]['datasets']['SU23']=[]
conf['steps'][9]['datasets']['SU23'].append(30001) # SU2 | nominal +- JAM17 uncertainties 
conf['steps'][9]['datasets']['SU23'].append(30002) # SU3 | nominal +- JAM17 uncertainties 

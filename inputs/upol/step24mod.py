...
#------------------------------------------------------------------------------------------------------------------
conf['datasets']['idis']['xlsx'][90101]='EIC/expdata/90101.xlsx' # proton   | A_PV | mean
conf['datasets']['idis']['xlsx'][90102]='EIC/expdata/90102.xlsx' # deuteron | A_PV | mean
#------------------------------------------------------------------------------------------------------------------
...
#conf['steps'][21]['active distributions']=['pdf','ht4','off']
#conf['steps'][21]['passive distributions']=[]
##------------------------------------------------------------------------------------------------------------------
...
#conf['steps'][21]['datasets']['dy']=[]
#conf['steps'][21]['datasets']['dy'].append(10001)
#conf['steps'][21]['datasets']['dy'].append(10002)
#conf['steps'][21]['datasets']['zrap']=[]
#conf['steps'][21]['datasets']['zrap'].append(1000)
#conf['steps'][21]['datasets']['zrap'].append(1001)
#conf['steps'][21]['datasets']['wasym']=[]
#conf['steps'][21]['datasets']['wasym'].append(1000)
#conf['steps'][21]['datasets']['wasym'].append(1001)
#conf['steps'][21]['datasets']['wzrv']=[]
#conf['steps'][21]['datasets']['wzrv'].append(2000)
#conf['steps'][21]['datasets']['wzrv'].append(2003)
#conf['steps'][21]['datasets']['wzrv'].append(2006)
#conf['steps'][21]['datasets']['wzrv'].append(2007)
#conf['steps'][21]['datasets']['wzrv'].append(2009)
#conf['steps'][21]['datasets']['wzrv'].append(2010)
#conf['steps'][21]['datasets']['wzrv'].append(2011)
#conf['steps'][21]['datasets']['wzrv'].append(2012)
#conf['steps'][21]['datasets']['wzrv'].append(2013)
#conf['steps'][21]['datasets']['wzrv'].append(2014)
...
#conf['offshell'] = True
#conf['steps'][23]={}
#conf['steps'][23]['dep']=[21,22]
#conf['steps'][23]['active distributions']=['pdf','ht4','off','eweak']
#conf['steps'][23]['passive distributions']=[]
#conf['params']['pdf']['sea2 N']['prior'] = 'sea1 N'
#conf['params']['pdf']['sea2 a']['prior'] = 'sea1 a'
#conf['params']['pdf']['sea2 b']['prior'] = 'sea1 b'
##------------------------------------------------------------------------------------------------------------------
#conf['steps'][23]['datasets']={}
#conf['steps'][23]['datasets']['idis']=[]
#conf['steps'][23]['datasets']['idis'].append(10010) # proton   | F2            | SLAC
#conf['steps'][23]['datasets']['idis'].append(10011) # deuteron | F2            | SLAC
#conf['steps'][23]['datasets']['idis'].append(10016) # proton   | F2            | BCDMS
#conf['steps'][23]['datasets']['idis'].append(10017) # deuteron | F2            | BCDMS
#conf['steps'][23]['datasets']['idis'].append(10020) # proton   | F2            | NMC
#conf['steps'][23]['datasets']['idis'].append(10021) # d/p      | F2d/F2p       | NMC
#conf['steps'][23]['datasets']['idis'].append(10026) # proton   | sigma red     | HERA II NC e+ (1)
#conf['steps'][23]['datasets']['idis'].append(10027) # proton   | sigma red     | HERA II NC e+ (2)
#conf['steps'][23]['datasets']['idis'].append(10028) # proton   | sigma red     | HERA II NC e+ (3)
#conf['steps'][23]['datasets']['idis'].append(10029) # proton   | sigma red     | HERA II NC e+ (4)
#conf['steps'][23]['datasets']['idis'].append(10030) # proton   | sigma red     | HERA II NC e-
#conf['steps'][23]['datasets']['idis'].append(10031) # proton   | sigma red     | HERA II CC e+
#conf['steps'][23]['datasets']['idis'].append(10032) # proton   | sigma red     | HERA II CC e-
#conf['steps'][23]['datasets']['idis'].append(10002) # deuteron | F2            | JLab Hall C (E00-106)
#conf['steps'][23]['datasets']['idis'].append(10003) # proton   | F2            | JLab Hall C (E00-106)
#conf['steps'][23]['datasets']['idis'].append(10033) # n/d      | F2n/F2d       | BONUS
#conf['steps'][23]['datasets']['dy']=[]
#conf['steps'][23]['datasets']['dy'].append(10001)
#conf['steps'][23]['datasets']['dy'].append(10002)
#conf['steps'][23]['datasets']['zrap']=[]
#conf['steps'][23]['datasets']['zrap'].append(1000)
#conf['steps'][23]['datasets']['zrap'].append(1001)
#conf['steps'][23]['datasets']['wasym']=[]
#conf['steps'][23]['datasets']['wasym'].append(1000)
#conf['steps'][23]['datasets']['wasym'].append(1001)
#conf['steps'][23]['datasets']['wzrv']=[]
#conf['steps'][23]['datasets']['wzrv'].append(2000)
#conf['steps'][23]['datasets']['wzrv'].append(2003)
#conf['steps'][23]['datasets']['wzrv'].append(2006)
#conf['steps'][23]['datasets']['wzrv'].append(2007)
#conf['steps'][23]['datasets']['wzrv'].append(2009)
#conf['steps'][23]['datasets']['wzrv'].append(2010)
#conf['steps'][23]['datasets']['wzrv'].append(2011)
#conf['steps'][23]['datasets']['wzrv'].append(2012)
#conf['steps'][23]['datasets']['wzrv'].append(2013)
#conf['steps'][23]['datasets']['wzrv'].append(2014)
...
conf['offshell'] = True
conf['steps'][24]={}
conf['steps'][24]['dep']=[22,23]
conf['steps'][24]['active distributions']=['pdf','ht4','off','eweak']
conf['steps'][24]['passive distributions']=[]
#------------------------------------------------------------------------------------------------------------------
conf['steps'][24]['datasets']={}
conf['steps'][24]['datasets']['idis']=[]
conf['steps'][24]['datasets']['idis'].append(10010) # proton   | F2            | SLAC
conf['steps'][24]['datasets']['idis'].append(10011) # deuteron | F2            | SLAC
conf['steps'][24]['datasets']['idis'].append(10016) # proton   | F2            | BCDMS
conf['steps'][24]['datasets']['idis'].append(10017) # deuteron | F2            | BCDMS
conf['steps'][24]['datasets']['idis'].append(10020) # proton   | F2            | NMC
conf['steps'][24]['datasets']['idis'].append(10021) # d/p      | F2d/F2p       | NMC
conf['steps'][24]['datasets']['idis'].append(10026) # proton   | sigma red     | HERA II NC e+ (1)
conf['steps'][24]['datasets']['idis'].append(10027) # proton   | sigma red     | HERA II NC e+ (2)
conf['steps'][24]['datasets']['idis'].append(10028) # proton   | sigma red     | HERA II NC e+ (3)
conf['steps'][24]['datasets']['idis'].append(10029) # proton   | sigma red     | HERA II NC e+ (4)
conf['steps'][24]['datasets']['idis'].append(10030) # proton   | sigma red     | HERA II NC e-
conf['steps'][24]['datasets']['idis'].append(10031) # proton   | sigma red     | HERA II CC e+
conf['steps'][24]['datasets']['idis'].append(10032) # proton   | sigma red     | HERA II CC e-
conf['steps'][24]['datasets']['idis'].append(10002) # deuteron | F2            | JLab Hall C (E00-106)
...
conf['steps'][24]['datasets']['idis'].append(90101) # proton   | A_PV | mean
conf['steps'][24]['datasets']['idis'].append(90102) # deuteron | A_PV | mean
conf['steps'][24]['datasets']['dy']=[]
conf['steps'][24]['datasets']['dy'].append(10001)
conf['steps'][24]['datasets']['dy'].append(10002)
conf['steps'][24]['datasets']['zrap']=[]
conf['steps'][24]['datasets']['zrap'].append(1000)
conf['steps'][24]['datasets']['zrap'].append(1001)
conf['steps'][24]['datasets']['wasym']=[]
conf['steps'][24]['datasets']['wasym'].append(1000)
conf['steps'][24]['datasets']['wasym'].append(1001)
conf['steps'][24]['datasets']['wzrv']=[]
conf['steps'][24]['datasets']['wzrv'].append(2000)
conf['steps'][24]['datasets']['wzrv'].append(2003)
conf['steps'][24]['datasets']['wzrv'].append(2006)
conf['steps'][24]['datasets']['wzrv'].append(2007)
conf['steps'][24]['datasets']['wzrv'].append(2009)
conf['steps'][24]['datasets']['wzrv'].append(2010)
conf['steps'][24]['datasets']['wzrv'].append(2011)
conf['steps'][24]['datasets']['wzrv'].append(2012)
conf['steps'][24]['datasets']['wzrv'].append(2013)
conf['steps'][24]['datasets']['wzrv'].append(2014)
conf['steps'][24]['datasets']['wzrv'].append(2015)

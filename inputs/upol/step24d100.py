...
conf['datasets']['idis']['xlsx'][90002]='EIC/expdata/90002.xlsx' # deuteron | A_PV | mean | 100fb-1
conf['datasets']['idis']['xlsx'][90003]='EIC/expdata/90003.xlsx' # deuteron | A_PV | mean | 100fb-1
#------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------
#--fit EIC data (deuteron only, 100 fb-1)
conf['tmc']   = 'AOT'
conf['ht']    = True
conf['ht type'] = 'mult'
conf['offshell'] = True
...
conf['steps'][24]['datasets']['idis'].append(90003) # deuteron | A_PV | mean

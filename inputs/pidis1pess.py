...
## --------------------------------------------------------------------------------------------------------------------------
conf['datasets']['pidis']['xlsx'][90001] = 'pidis/expdata/90001.xlsx' # 90001 | proton   | A_PV | JAM4EIC         | Optimistic  |
conf['datasets']['pidis']['xlsx'][90011] = 'pidis/expdata/90001.xlsx' # 90011 | proton   | A_PV | JAM4EIC         | Moderate    |
conf['datasets']['pidis']['xlsx'][90021] = 'pidis/expdata/90001.xlsx' # 90021 | proton   | A_PV | JAM4EIC         | Pessimistic |
## --------------------------------------------------------------------------------------------------------------------------
...
conf['steps'][9]['datasets']['pidis'].append(90021) # 90021 | proton   | A_PV | JAM4EIC         |          |
